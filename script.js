...
async function cargarMenu() {
    try {
        const respuesta = await fetch("https://script.google.com/macros/s/AKfycbzTr1WF7VcgabKxS3G2WvhB-Yc2jjlc1imP7Wrd_ZprsIysXYb-0ieg7Dopc9DGXARqIw/exec");
...
function enviarPedido() {
    ...
    fetch("https://script.google.com/macros/s/AKfycbzTr1WF7VcgabKxS3G2WvhB-Yc2jjlc1imP7Wrd_ZprsIysXYb-0ieg7Dopc9DGXARqIw/exec", {
        method: "POST",
        mode: "no-cors",
        headers: {
